            ...
            <table class="table table-borderless">
              ...
              <tbody class="venue_main">
                ...
                <tr>
                  ...
                  <td>{{$venue_breakdown->unit_cost}}</td>
                  <td>{{$venue_breakdown->unit_count}}</td>
                  <td>{{$venue_breakdown->unit_subtotal}}</td>
                </tr>
                @endif
                @endforeach
              </tbody>
              <tbody class="venue_result">
                <tr>
                  <td colspan="2"></td>
                  <td colspan="1">合計：</td>
                  <td colspan="1" class=""> {{$reservation->bills()->first()->venue_price}}</td>
                </tr>
              </tbody>
            </table>
          </div>
            ...
            <table class="table table-borderless">
              ...
              <tbody class="equipment_main">
                ...
                <tr>
                  ...
                  <td>{{$equipment_breakdown->unit_cost}}</td>
                  <td>{{$equipment_breakdown->unit_count}}</td>
                  <td>{{$equipment_breakdown->unit_subtotal}}</td>
                </tr>
                @endif
                @endforeach
                ...
                <tr>
                  ...
                  <td>{{$service_breakdown->unit_cost}}</td>
                  <td>{{$service_breakdown->unit_count}}</td>
                  <td>{{$service_breakdown->unit_subtotal}}</td>
                </tr>
                @endif
                @endforeach
              </tbody>
            ...
            <table class="table table-borderless">
              ...
              <tbody class="layout_result">
                <tr>
                  <td colspan="2"></td>
                  <td colspan="1">合計：</td>
                  <td colspan="2">合計：{{$reservation->bills()->first()->layout_price}}
                  </td>
                </tr>
              </tbody>
            </table>
            ...
            <table class="table table-borderless">
              ...
              <tbody class="others_main">
                ...
                <tr>
                  ...
                  <td>{{$others_breakdown->unit_cost}}</td>
                  <td>{{$others_breakdown->unit_count}}</td>
                  <td>{{$others_breakdown->unit_subtotal}}</td>
                </tr>
                @endif
                @endforeach
              </tbody>
              ...
              <table class="table text-right" style="table-layout: fixed; font-size:16px;">
                <tbody>
                  <tr>
                    <td>小計：</td>
                    <td>
                      {{$reservation->bills()->first()->master_subtotal}}
                    </td>
                  </tr>
                  <tr>
                    <td>消費税：</td>
                    <td>
                      {{$reservation->bills()->first()->master_tax}}
                    </td>
                  </tr>
                  <tr>
