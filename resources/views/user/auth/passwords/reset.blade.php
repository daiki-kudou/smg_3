...
<head>
  ...
  <link href="http://127.0.0.1:8000/css/homepage/style.css" rel="stylesheet">

  <link rel='stylesheet' type='text/css' property='stylesheet'
    href='//127.0.0.1:8000/_debugbar/assets/stylesheets?v=1609942904&theme=auto'>
  <script type='text/javascript' src='//127.0.0.1:8000/_debugbar/assets/javascript?v=1609942904'></script>
  <script type="text/javascript">
          ...
          <div class="bgColorGray">
            <table>
              <tr>
                ...
                <td>
                  <input id="email" type="email" class="text1 form-control " name="email" value="" required
                    autocomplete="email" autofocus>
                </td>
              </tr>
              <tr>
                <th>パスワード<span class="txtRed c-block">＊</span></th>
                <td>
                  <input type="password" class="text1">
                </td>
              </tr>
              <tr>
                <th>パスワード（確認）<span class="txtRed c-block">＊</span></th>
                <td>
                  <input type="password" class="text1">
                </td>
              </tr>
