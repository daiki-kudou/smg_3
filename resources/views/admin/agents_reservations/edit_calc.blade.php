          ...
          <tr>
            ...
            <td>
              <select name="enter_time" id="sales_start" class="form-control">
                ...
                {!!ReservationHelper::timeOptionsWithRequest($inputs['enter_time'])!!}
              </select>
            </td>
          </tr>
          <tr>
            ...
            <td>
              <select name="leave_time" id="sales_finish" class="form-control">
                <option disabled selected></option>
                {!!ReservationHelper::timeOptionsWithRequest($inputs['leave_time'])!!}
              </select>
            </td>
          </tr>
        </table>
          ...
          <tr>
            ...
            <td>
              <div class="d-flex align-items-center">
                {{ Form::text('end_user_charge', $inputs['end_user_charge'],['class'=>'form-control ', 'placeholder'=>'入力してください'] ) }}
