                    ...
                    <tbody class="accordion-wrap">
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          {{Form::number('equipment_breakdown' . $e_key.'_copied'.$key , $pre_re->unit_count, ['class' => 'form-control equipment_validation'])}}
                          @break
                          @elseif($loop->last)
                        ...
                        <table class="table table-borderless">
                          ...
                          <tbody class="{{'venue_main'.$key}}">
                            ...
                            <tr>
                              ...
                              <td>
                                {{ Form::text('venue_breakdown_count0_copied'.$key, 1,['class'=>'form-control', 'readonly'] ) }}
                              </td>
                              <td>
