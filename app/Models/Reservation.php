  ...
  public function ReserveStoreSession($request, $sessionName, $sessionName2)
  {
    ...
    DB::transaction(function () use ($master_info, $request, $sessionName2) { //トランザクションさせる
      $reservation = $this->create([
        ...
        'luggage_count' => !empty($master_info['luggage_count']) ? $master_info['luggage_count'] : "",
        'luggage_arrive' => !empty($master_info['luggage_arrive']) ? $master_info['luggage_arrive'] : "",
        'luggage_return' => !empty($master_info['luggage_return']) ? $master_info['luggage_return'] : "",
