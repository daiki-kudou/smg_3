            ...
            <tbody class="venue_result">
              <tr>
                ...
                <td colspan="1">
                  ...
                  @foreach (collect($reservation['bills'][0]['breakdowns'])->where('unit_type',1) as $key=>$value)
                  @if (strpos($value['unit_item'],'割引料金')!==false)
                  {{ Form::text('venue_price', ((int)$reservation['bills'][0]['venue_price'])+((int)-$value['unit_cost']),['class'=>'form-control col-xs-3', 'readonly'] ) }}
                  @break
                  @elseif($loop->last)
                  {{ Form::text('venue_price', (int)$reservation['bills'][0]['venue_price'],['class'=>'form-control col-xs-3', 'readonly'] ) }}
                  @endif
                  @endforeach
                </td>
              </tr>
            ...
            <tbody class="equipment_result">
              <tr>
                ...
                <td colspan="1">
                  ...
                  @foreach (collect($reservation['bills'][0]['breakdowns'])->where('unit_type',2) as $key=>$value)
                  @if (strpos($value['unit_item'],'割引料金')!==false)
                  {{ Form::text('equipment_price', ((int)$reservation['bills'][0]['equipment_price'])+((int)-$value['unit_cost']),['class'=>'form-control col-xs-3', 'readonly'] ) }}
                  @break
                  @elseif($loop->last)
            ...
            <tbody class="layout_result">
              <tr>
                ...
                <td colspan="1">
                  ...
                  @foreach (collect($reservation['bills'][0]['breakdowns'])->where('unit_type',4) as $key=>$value)
                  @if (strpos($value['unit_item'],'割引料金')!==false)
                  {{ Form::text('layout_price', ((int)$reservation['bills'][0]['layout_price'])+((int)-$value['unit_cost']),['class'=>'form-control col-xs-3', 'readonly'] ) }}
                  @break
                  @elseif($loop->last)
                  {{ Form::text('layout_price', (int)$reservation['bills'][0]['layout_price'],['class'=>'form-control col-xs-3', 'readonly'] ) }}
                  @endif
                  @endforeach
                </td>
              </tr>
          ...
          <table class="table table-borderless">
            ...
            <tbody class="others_result">
              <tr>
                ...
                <td colspan="1">
                  <p class="text-left">合計</p>
                  {{ Form::text('others_price', (int)$reservation['bills'][0]['others_price'],['class'=>'form-control col-xs-3', 'readonly'] ) }}
                </td>
              </tr>
            </tbody>
          </table>
