...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <hr>
        {{ Form::open(['url' => '/admin/bills/check', 'method' => 'get', 'id' => 'billsCreateForm', 'autocomplete' => 'off']) }}
        @csrf
                                    ...
                                    <tr>
                                        <td colspan="5">
                                            <div class="venue_chkbox">
                                                <input type="checkbox" id="venue" name="venue" value="1" {{ !empty($data['venue_price']) ? 'checked' : '' }}>
                                    ...
                                    <tr>
                                        <td colspan="5">
                                            <div class="equipment_chkbox">
                                                <input type="checkbox" id="equipment" name="equipment" value="1" {{ !empty($data['equipment_price']) ? 'checked' : '' }}>
                                    ...
                                    <tr>
                                        <td colspan="5">
                                            <div class="layout_chkbox">
                                                <input type="checkbox" id="layout" name="layout" value="1" {{ !empty($data['layout_price']) ? 'checked' : '' }}>
                                    ...
                                    <tr>
                                        <td colspan="5">
                                            <div class="others_chkbox">
                                                <input type="checkbox" id="others" name="others" value="1" {{ !empty($data['others_price']) ? 'checked' : '' }}>
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>支払期日
                                            {{ Form::text('payment_limit', $payment_limit, [
                                    ...
                                    <tr>
                                        <td>請求書宛名
                                            {{ Form::text('bill_company', ReservationHelper::getCompany($reservation['user']['id']), ['class' => 'form-control']) }}
                                        </td>
                                        <td>
                                            担当者
        ...
        {{ Form::submit('確認する', ['class' => 'btn more_btn_lg mx-auto d-block mt-5 submit_btn', empty($data['master_total']) ? 'disabled' : '']) }}
        {{ Form::close() }}
