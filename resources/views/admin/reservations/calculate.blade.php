      ...
      <table class="table table-bordered sale-table" style="table-layout:fixed;">
        <tbody>
          ...
          <tr>
            ...
            <td>
              <div class="d-flex align-items-end">
                {{ Form::text('', $value['cost'],['class'=>'form-control'] ) }}
...
{{ Form::open(['url' => 'admin/reservations/check_session', 'method'=>'POST', 'id'=>'agents_calculate_form']) }}
@csrf
<section class="">
  <div class="bill">
    <div class="bill_head">
    ...
    <div class="bill_details">
      ...
      <div class="main">
        ...
        @if(ReservationHelper::judgeArrayEmpty($priceResult['item_details'])==1||$request->luggage_price)
