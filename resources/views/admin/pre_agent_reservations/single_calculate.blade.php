                        ...
                        <table class="table text-right" style="table-layout: fixed;">
                            <tbody>
                                ...
                                <tr>
                                    <td>消費税：</td>
                                    <td>
                                        {{ Form::text('master_tax', ReservationHelper::getTax(($price + $layout_total)), ['class' => 'form-control text-right', 'readonly']) }}
                                    </td>
                                </tr>
                                <tr>
                                    <td class="font-weight-bold">合計金額</td>
                                    <td>
                                        {{ Form::text('master_total', ReservationHelper::taxAndPrice(($price + $layout_total)), ['class' => 'form-control text-right', 'readonly']) }}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
