        ...
        <table class="table table-bordered table_fixed">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>セイ：{{ Form::text('lastname_kana', old('lastname_kana'), ['class' => 'form-control']) }}
              </td>
              <td>メイ：{{ Form::text('firstname_kana', old('firstname_kana'), ['class' => 'form-control'])}}
              </td>
            </tr>
            <tr>
        ...
        <table class="table table-bordered table_fixed">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td colspan="2">{{ Form::text('login_id', old('login_id'), ['class' => 'form-control']) }}
              </td>
            </tr>
            <tr>
        ...
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ Form::text('payment_day', old('payment_day') ,['class'=>'form-control', 'id'=>'datepicker1'] ) }}</td>
            </tr>
