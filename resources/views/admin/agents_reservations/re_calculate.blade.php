                        ...
                        <td>
                            <select id="venues_selector" class=" form-control" name='venue_id'>
                                ...
                                @foreach ($venues as $venue)
                                    <option value="{{ $venue->id }}" @if ($all_requests['venue_id'] == $venue->id) selected @endif>{{ $venue->name_area }}{{ $venue->name_bldg }}{{ $venue->name_venue }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <table class='table table-bordered' style="table-layout:fixed;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    {{ Form::text('luggage_count', empty($all_requests['luggage_count']) ? '' : $all_requests['luggage_count'], ['class' => 'form-control', 'min' => 0]) }}
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>事後返送する荷物</td>
                                <td>
                                    {{ Form::number('luggage_return', empty($all_requests['luggage_return']) ? '' : $all_requests['luggage_return'], ['class' => 'form-control', 'min' => 0]) }}
                            ...
                            <td>
                                <select class="form-control" name="agent_id" id="agent_select">
                                    ...
                                    @foreach ($agents as $agent)
                                        <option value="{{ $agent->id }}" @if ($agent->id == $all_requests['agent_id']) selected @endif>{{ $agent->name }} |{{ ReservationHelper::getAgentPerson($agent->id) }}| {{ $agent->email }}
                                        </option>
                                    @endforeach
                                </select>
                ...
                <div class="main">
                    <div class="paids" style="padding-top: 20px; width:90%; margin:0 auto;">
                        <table class="table" style="table-layout: fixed;">
                            ...
                            <tr>
                                <td>振込名{{ Form::text('pay_person', null, ['class' => 'form-control']) }}</td>
