                ...
                <table class="table table-bordered reserve_table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                {{ Form::text('reserve_date', $value['reserve_date'], ['class' => 'form-control', 'id' => '', 'placeholder' => '入力してください', 'readonly']) }}
                        ...
                        <tr>
                            ...
                            <td>
                                {{ Form::text('', $value['price_system'] == 1 ? '通常（枠貸）' : '音響HG', ['class' => 'form-control', 'readonly']) }}
                ...
                <div class="equipemnts">
                    <table class="table table-bordered">
                        <thead class="accordion-ttl">
                            <tr>
                                <th colspan="2">
                                    <p class="title-icon fw-bolder py-1 active">
                        ...
                        <table class="table table-bordered" style="table-layout:fixed;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{ Form::number('luggage_count', $value['luggage_count'] ?? null, ['class' => 'form-control', 'id' => 'luggage_count', 'min' => 0]) }}
                                ...
                                <tr>
                                    ...
                                    <td>
                                        {{ Form::number('luggage_return', !empty($value['luggage_return']) ? $value['luggage_return'] : '', ['class' => 'form-control', 'id' => 'luggage_return', 'min' => 0]) }}
                            ...
                            <td>
                                <select class="form-control" name="user_id" id="user_select">
                                    ...
                                    @foreach ($users as $user)
                                        <option value="{{ $user->id }}" @if ((int) $value['user_id'] == $user->id) selected @endif>
                            ...
                            <tbody class="others_main">
                                @if (!empty($checkInfo) && ($checkInfo['others_breakdown_item0'] || $checkInfo['others_breakdown_cost0'] || $checkInfo['others_breakdown_count0'] || $checkInfo['others_breakdown_subtotal0']))
                                    @for ($i = 0; $i < $others_count; $i++)
                                        <tr>
                                            <td>{{ Form::text('others_breakdown_item' . $i, $checkInfo['others_breakdown_item' . $i], ['class' => 'form-control']) }}</td>
                                            <td>{{ Form::text('others_breakdown_cost' . $i, $checkInfo['others_breakdown_cost' . $i], ['class' => 'form-control']) }}</td>
                                            <td>{{ Form::text('others_breakdown_count' . $i, $checkInfo['others_breakdown_count' . $i], ['class' => 'form-control']) }}</td>
                                            <td>{{ Form::text('others_breakdown_subtotal' . $i, $checkInfo['others_breakdown_subtotal' . $i], ['class' => 'form-control', 'readonly']) }}</td>
                                            <td class="text-left">
