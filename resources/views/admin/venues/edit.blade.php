      ...
      <div class="col">
        ...
        <table class="table table-bordered venue_table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{{ Form::text('name_area', $venue->name_area, ['class' => 'form-control']) }}
        ...
        <table class="table table-bordered">
          ...
          <tbody>
            <tr>
              ...
              <td>{{Form::select('luggage_flag', ['無し', '有り'],$venue->luggage_flag,['placeholder' => '選択してください','class'=>'custom-select mr-sm-2'])}}
            ...
            <tr>
              ...
              <td>{{ Form::text('luggage_address1', $venue->luggage_address1, ['class' => 'form-control']) }}
            ...
            <tr>
              ...
              <td>{{ Form::text('luggage_address2', $venue->luggage_address2, ['class' => 'form-control']) }}
                <p class="is-error-luggage_address2" style="color: red"></p>
              </td>
            </tr>
            <tr>
              <td class="table-active">{{ Form::label('luggage_address3', '住所（建物名）',['class' => 'form_required']) }}</td>
              <td>{{ Form::text('luggage_address3', $venue->luggage_address3, ['class' => 'form-control']) }}
            ...
            <tr>
              ...
              <td>{{ Form::text('luggage_name', $venue->luggage_name, ['class' => 'form-control']) }}
                <p class="is-error-luggage_name" style="color: red"></p>
              </td>
            </tr>
            <tr>
              <td class="table-active">{{ Form::label('luggage_tel', '電話番号',['class' => 'form_required']) }}</td>
              <td>{{ Form::text('luggage_tel', $venue->luggage_tel, ['class' => 'form-control']) }}
                <p class="is-error-capacity" style="color: red"></p>
              </td>
            </tr>
          </tbody>
        ...
        <!-- <div class="p-3 mb-2 bg-white text-dark">
          ...
          <div class="row">
            ...
            <div class="col-sm-8">{{ Form::text('name_area', $venue->name_area, ['class' => 'form-control']) }}
              <p class="is-error-name_area" style="color: red"></p>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-8">{{ Form::text('name_bldg', $venue->name_bldg, ['class' => 'form-control']) }}
              <p class="is-error-name_bldg" style="color: red"></p>
            </div>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-sm-8">{{ Form::text('name_venue', $venue->name_venue, ['class' => 'form-control']) }}
              <p class="is-error-name_venue" style="color: red"></p>
            </div>
          </div>
        ...
        <table class="table table-bordered table_fixed">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>姓：{{ Form::text('first_name', $venue->first_name, ['class' => 'form-control']) }}</td>
              <td>名：{{ Form::text('last_name', $venue->last_name, ['class' => 'form-control']) }}</td>
            </tr>
            <tr>
              <td class="table-active">{{ Form::label('first_name_kana', '担当者氏名（ふりがな）') }}</td>
              <td>セイ：{{ Form::text('first_name_kana', $venue->first_name_kana, ['class' => 'form-control'])}}
              </td>
              <td>メイ：{{ Form::text('last_name_kana', $venue->last_name_kana, ['class' => 'form-control']) }}
              </td>
            </tr>
            <!-- 工藤さんに確認　顧客の新規登録のデータをピックアップ問題ないか -->
        ...
        <table class="table table-bordered table_fixed">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>姓：{{ Form::text('mgmt_first_name', $venue->mgmt_first_name, ['class' => 'form-control']) }}</td>
              <td>名：{{ Form::text('mgmt_last_name', $venue->mgmt_last_name, ['class' => 'form-control']) }}</td>
            </tr>
            <!-- 工藤さんに確認　顧客の新規登録のデータをピックアップ問題ないか -->
