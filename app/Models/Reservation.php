...
class Reservation extends Model implements PresentableInterface
{
	...
	public function ReservationUpdate($data)
	{
		...
		$this->update([
			...
			'leave_time' => $data['leave_time'],
			'board_flag' => $data['board_flag'],
			'event_start' => !empty($data['event_start']) ? $data['event_start'] : '00:00:00',
			'event_finish' => !empty($data['event_finish']) ? $data['event_finish'] : '00:00:00',
	...
	public function ReservationSearchTarget()
	{
      ...
      concat(venues.name_area, "・", venues.name_bldg,venues.name_venue) as venue_name_user, 
