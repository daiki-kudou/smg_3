                ...
                <div class="price_selector">
                  ...
                  <div class="price_radio_selector">
                    ...
                    <div class="d-flex justfy-content-start align-items-center">
                      {{Form::radio('price_system', 1, $request->price_system==1?true:false , ['id' =>
                      'price_system_radio1', 'class' => 'mr-2'])}}
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex align-items-end">
                    {{ Form::number('equipment_breakdown'.$e_key,
                    $request->{'equipment_breakdown'.$e_key},['class'=>'form-control equipment_validation'] ) }}
            ...
            <tbody class="accordion-wrap">
              ...
              <tr>
                ...
                <td>
                  <div class="radio-box">
                    <p>
                      {{Form::radio('services_breakdown'.$s_key, 1,
                      $request->{'services_breakdown'.$s_key}==1?true:false , ['id' => 'service'.$s_key.'on'])}}
                      {{Form::label('service'.$s_key.'on', "有り")}}
                    </p>
                    <p>
                      {{Form::radio('services_breakdown'.$s_key, 0,
                      $request->{'services_breakdown'.$s_key}==0?true:false, ['id' =>
                      'services_breakdown'.$s_key.'off'])}}
              ...
              <tr>
                ...
                <td>
                  <div class="radio-box">
                    ...
                    <p>
                      {{Form::radio('layout_clean', 0, $request->layout_clean==0?true:false, ['id' =>
                      'no_layout_clean'])}}
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <div class="radio-box">
                    <p>
                      {{Form::radio('luggage_flag', 1, (int)$request->luggage_flag===1?true:false , ['id'
                      =>'luggage_flag', 'class' => ''])}}
                      {{Form::label('luggage_flag','有り')}}
                    </p>
                    <p>
                      {{Form::radio('luggage_flag', 0, (int)$request->luggage_flag===0?true:false, ['id'
                      =>'no_luggage_flag', 'class' => ''])}}
              ...
              <tr>
                ...
                <td>
                  ...
                  (int)$request->luggage_flag===1?$request->luggage_count:"",['class'=>'form-control','id'=>'luggage_count']
                  ) }}
              ...
              <tr>
                ...
                <td>
                  ...
                  (int)$request->luggage_flag===1?$request->luggage_return:"",['class'=>'form-control','id'=>'luggage_return']
                  ) }}
          ...
          <table class="table table-borderless">
            ...
            <tbody class="layout_main">
              ...
              <tr>
                ...
                <td>
                  {{ Form::text('layout_breakdown_subtotal[]', $venue->getLayouts()[0],['class'=>'form-control',
                  'readonly'] ) }}
                </td>
              </tr>
              @endif
              ...
              <tr>
                ...
                <td>{{ Form::text('layout_breakdown_count[]', 1,['class'=>'form-control', 'readonly'] )}}</td>
                <td>
                  {{ Form::text('layout_breakdown_subtotal[]', $venue->getLayouts()[1],['class'=>'form-control',
                  'readonly'] ) }}
                </td>
              </tr>
              @endif
          ...
          <table class="table text-right" style="table-layout: fixed;">
            <tbody>
              <tr>
                <td>小計：</td>
                <td>
                  {{ Form::text('master_subtotal',(floor($price+$layout_total)) ,['class'=>'form-control text-right',
                  'readonly'] ) }}
                </td>
              </tr>
              <tr>
                <td>消費税：</td>
                <td>
                  {{ Form::text('master_tax',ReservationHelper::getTax(floor($price+$layout_total))
              ...
              <tr>
                ...
                <td>
                  {{ Form::text('master_total',ReservationHelper::taxAndPrice(floor($price+$layout_total))
                  ,['class'=>'form-control text-right', 'readonly'] ) }}
                </td>
              </tr>
            </tbody>
