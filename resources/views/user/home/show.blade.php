                    ...
                    <table class="table table-bordered mb-0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <p>
                                        {{ ReservationHelper::getVenueForUser($reservation->venue_id) . ($reservation->price_system === 2 ? '(音響HG)' : '') }}
                                    </p>
                                </td>
                            </tr>
                            <tr>
            ...
            <div class="confirm-box text-sm-center">
                ...
                <p class="text-center mt-3">
                    {{ Form::model($reservation, [
                        'method' => 'PUT',
                        'route' => ['user.home.updatestatus', $reservation->id],
                        'class' => 'text-center',
                    ]) }}
                    @csrf
                                    ...
                                    <td>
                                        <ul class="d-sm-flex justify-content-between">
                                            ...
                                            <li>
                                                ...
                                                <p><span>予約確定日：</span>
                                                    {{ !empty($other_bill->cfm_at) ? ReservationHelper::formatDate($other_bill->cfm_at) : '' }}
                                                </p>
                                            </li>
                                        </ul>
                                    </td>
