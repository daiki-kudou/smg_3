        ...
        <div class="informations billdetails_content">
          <table class="table">
            <tbody>
              ...
              <tr>
                <td>請求書宛名
                  {{ Form::text('pay_company', $reservation->agent->name, ['class' => 'form-control'])}}
                </td>
                <td>
                  担当者
                  {{ Form::text('bill_person', ReservationHelper::getAgentPerson($reservation->agent->id), ['class' => 'form-control' ])}}
