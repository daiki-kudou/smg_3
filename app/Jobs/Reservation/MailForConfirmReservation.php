...
use App\Mail\UserFinRes;
use App\Mail\FailedMail;
use Carbon\Carbon;
use Mail;

class MailForConfirmReservation implements ShouldQueue
{
  ...
  public function handle()
  {
    ...
    $subject = "【会議室｜[予約情報：会場予約]：" . $reservation_data->reservation_id . "】予約完了/お支払のお知らせ（SMG貸し会議室）";
