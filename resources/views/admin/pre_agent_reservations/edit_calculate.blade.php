                  ...
                  <div class="price_radio_selector">
                    ...
                    <div class="price_radio_selector">
                      <div class="d-flex justfy-content-start align-items-center">
                        {{ Form::radio('price_system', 1, $request->price_system==1?true:false, ['class'=>'mr-2',
            ...
            <table class="table table-borderless">
              ...
              <tbody class="layout_main">
                ...
                <tr>
                  ...
                  <td>
                    {{ Form::text('layout_prepare_subtotal', $venue->getLayouts()[0],['class'=>'form-control',
                    'readonly'] ) }}
                  </td>
                </tr>
                @endif
            ...
            <table class="table text-right" style="table-layout: fixed;">
              <tbody>
                <tr>
                  <td>小計：</td>
                  <td>
                    {{ Form::text('master_subtotal',(floor($price+$layout_prepare+$layout_clean))
                ...
                <tr>
                  <td>消費税：</td>
                  <td>
                    {{ Form::text('master_tax',ReservationHelper::getTax(floor($price+$layout_prepare+$layout_clean))
                    ,['class'=>'form-control text-right', 'readonly'] ) }}
                  </td>
                </tr>
                <tr>
                  ...
                  <td>
                    {{
                    Form::text('master_total',ReservationHelper::taxAndPrice(floor($price+$layout_prepare+$layout_clean))
                    ,['class'=>'form-control text-right', 'readonly'] ) }}
                  </td>
                </tr>
              </tbody>
