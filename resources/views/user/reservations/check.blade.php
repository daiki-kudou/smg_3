          ...
          <table>
            ...
            <tr>
              ...
              <td>
                ...
                ( <label><input type="checkbox" id="cataring02_1" name="cataring02[]" value="手配済"
  ...
  <script>
    // チェックボックス表示、非表示
      ...
      $(function () {
        ...
        $("input#baggage_b01, input#baggage_b02").change(function () {
          if ($("input#baggage_b01").is(":checked")) {
            $("tr.jizennimotsu").show();
          } else {
            $("tr.jizennimotsu").hide();
          }
        });
