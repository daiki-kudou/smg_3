    ...
    <main>
      <div class="contents">
        <div class="pagetop-text">
          <h1 class="page-title oddcolor"><span>404 File Not Found</span></h1>
        </div>
      </div>
      ...
      <section class="contents block">
        <div class="block">
          ...
          <p>SMGアクセア貸し会議室にアクセスいただきありがとうございます。
          </p>
          <p>当サイトは、2018年4月に全面リニューアルいたしました。

          </p>
          <p>ご使用のブラウザで［更新］［再読み込み］を行ってもこのページが表示される場合は、一時的にアクセスできない状況にあるか、お探しのページのURLが変更・削除された可能性があります。
          </p>
          <p>恐れ入りますが、以下ページ一覧よりご覧になりたいページをお探しください。
          </p>
        </div>
        <div class="sitemaplist">
          ...
          <ul>
            ...
            <li><a href="https://osaka-conference.com/privacypolicy/">プライバシーポリシー</a></li>
          </ul>
        </div>
      </section>
