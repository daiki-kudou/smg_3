...
<body>
  ...
  <p>
    ...
    <br /><br />詳細については、下記リンク先よりご確認をお願い致します。<br /><a
      href="{{'https://alliance-smg.herokuapp.com/user/home/'.$reservation_id->id}}">マイページより確認する</a><br /><br /><br />--------------------------------------------------------------<br />※このメールは自動返信用です。こちらのメールに返信いただきましてもご返答できませんので予めご了承ください。<br /><br />■お問い合わせについて　<br />=====================================<br />▼お電話で<br />TEL：06-6556-6462
