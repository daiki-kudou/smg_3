        ...
        <div class="d-flex align-items-center">
          <div class="row w-100">
            <div class="col text-right">
              ...
              {{ Form::open(['url' => '/admin/calendar/date_calendar', 'method' => 'get','id'=>'yesterday','autocomplete'=>'off']) }}
              @csrf
              {{ Form::hidden('date', $yesterday) }}
              {{ Form::close() }}
            </div>
            <div class="col">
              {{ Form::open(['url' => '/admin/calendar/date_calendar', 'method' => 'get','id'=>'s_calendar','autocomplete'=>'off']) }}
              @csrf
            ...
            <div class="col">
              ...
              {{ Form::open(['url' => '/admin/calendar/date_calendar', 'method' => 'get','id'=>'tomorrow','autocomplete'=>'off']) }}
              @csrf
