                                ...
                                <tr>
                                    <td colspan="4">
                                        <div class="venue_chkbox">
                                            <input type="checkbox" id="venue" name="venue" value="1" {{ !empty($data['venue_breakdown_item'][0]) ? 'checked' : '' }}>
                                ...
                                <tr>
                                    <td colspan="4">
                                        <div class="equipment_chkbox">
                                            <input type="checkbox" id="equipment" name="equipment" value="1" {{ !empty($data['equipment_breakdown_item'][0]) ? 'checked' : '' }}>
                                ...
                                <tr>
                                    <td colspan="5">
                                        <div class="layout_chkbox">
                                            <input type="checkbox" id="layout" name="layout" value="1" {{ !empty($data['layout_breakdown_item'][0]) ? 'checked' : '' }}>
                                ...
                                <tr>
                                    <td colspan="4">
                                        <div class="others_chkbox">
                                            <input type="checkbox" id="others" name="others" value="1" {{ !empty($data['others_breakdown_item'][0]) ? 'checked' : '' }}>
