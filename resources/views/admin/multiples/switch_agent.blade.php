...
{{ Form::open(['url' => '/admin/multiples/agent_switch_cfm/'.$multiple->id, 'method'=>'POST','id'=>'multipleagent_switch','autocomplete'=>'off',]) }}
@csrf
...
<div class="container-fluid">
  <div class="container-field mt-3">
    ...
    <h2 class="mt-3 mb-3">一括仮押え　仲介会社情報　変更</h2>
    <hr>
  </div>
          ...
          <tbody class="agent_info">
            <tr>
              <th class="table-active" width="25%">
                <label for="company">サービス名称</label>
              </th>
              <td>
