                        ...
                        <div class="venues billdetails_content">
                            <table class="table table-borderless">
                                ...
                                <tbody class="venue_main {{ empty($bill->venue_price) ? ' hide' : '' }}">
                                    @if (count(
                                        $bill->breakdowns()->where('unit_type', 1)->get()) != 0)
                                        @foreach ($bill->breakdowns()->where('unit_type', 1)->get() as $key => $venue)
                                            <tr>
                                                ...
                                                <td>
                                                    {{ Form::text('venue_breakdown_count[]', $venue->unit_count, [
                                                        'class' => 'form-control
                                                                        number_validation',
                                                    ]) }}
                                                </td>
                        ...
                        <div class="equipment billdetails_content">
                            <table class="table table-borderless">
                                ...
                                <tbody class="equipment_main {{ empty($bill->equipment_price) ? ' hide' : '' }}">
                                    @if (count(
                                        $bill->breakdowns()->where('unit_type', 2)->get()) != 0)
                                        @foreach ($bill->breakdowns()->where('unit_type', 2)->get() as $key => $equ)
                                            <tr>
                                                ...
                                                <td>
                                                    {{ Form::text('equipment_breakdown_count[]', $equ->unit_count, [
                                                        'class' => 'form-control
                                                                        number_validation',
                                                    ]) }}
                                                </td>
                        ...
                        <div class="layout billdetails_content">
                            <table class="table table-borderless">
                                ...
                                <tbody class="layout_main {{ empty($bill->layout_price) ? ' hide' : '' }}">
                                    @if (count(
                                        $bill->breakdowns()->where('unit_type', 4)->get()) != 0)
                                        @foreach ($bill->breakdowns()->where('unit_type', 4)->get() as $key => $lay)
                                            <tr>
                                                ...
                                                <td>
                                                    {{ Form::text('layout_breakdown_count[]', $lay->unit_count, [
                                                        'class' => 'form-control
                                                                        number_validation',
                                                    ]) }}
                                                </td>
                        ...
                        <div class="others billdetails_content">
                            <table class="table table-borderless">
                                ...
                                <tbody class="others_main {{ empty($bill->others_price) ? ' hide' : '' }}">
                                    @if (count(
                                        $bill->breakdowns()->where('unit_type', 5)->get()) != 0)
                                        @foreach ($bill->breakdowns()->where('unit_type', 5)->get() as $key => $other)
                                            <tr>
                                                ...
                                                <td>
                                                    {{ Form::text('others_breakdown_count[]', $other->unit_count, [
                                                        'class' => 'form-control
                                                                        number_validation',
                                                    ]) }}
                                                </td>
