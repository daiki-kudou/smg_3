...
@section('content')
    ...
    <div class="container-fluid">
        ...
        {{ Form::open(['url' => '/admin/bills/' . $bill->id . '/agent_edit_update', 'method' => 'psot', 'id' => 'agentsbillsEditForm', 'autocomplete' => 'off']) }}
        @csrf
        <section class="mt-5">
            <div class="bill">
                                    ...
                                    <tr>
                                        <td colspan="5">
                                            <div class="venue_chkbox">
                                                <input type="checkbox" id="venue" name="venue" value="1" {{ !empty($bill->breakdowns->where('unit_type', 1)->first()) ? 'checked' : '' }} class="checkbox">
                                    ...
                                    <tr>
                                        <td colspan="5">
                                            <div class="equipment_chkbox">
                                                <input type="checkbox" class="checkbox" id="equipment" name="equipment" value="1" {{ !empty($bill->breakdowns->where('unit_type', 2)->first()) ? 'checked' : '' }} class="checkbox">
                                    ...
                                    <tr>
                                        <td colspan="5">
                                            <div class="layout_chkbox">
                                                <input type="checkbox" class="checkbox" id="layout" name="layout" value="1" {{ !empty($bill->breakdowns->where('unit_type', 4)->first()) ? 'checked' : '' }}>
                                    ...
                                    <tr>
                                        <td colspan="5">
                                            <div class="others_chkbox">
                                                <input type="checkbox" class="checkbox" id="others" name="others" value="1" {{ !empty($bill->breakdowns->where('unit_type', 5)->first()) ? 'checked' : '' }} class="checkbox">
                            ...
                            <table class="table">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>支払期日
                                            {{ Form::text('payment_limit', date('Y-m-d', strtotime($bill->payment_limit)), [
                                                'class' => 'form-control
                                                                datepicker',
                                            ]) }}
                                        </td>
