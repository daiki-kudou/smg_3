            ...
            <div class="bgColorGray first">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            {{ Form::text('in_charge', $request->in_charge ?? null, ['class' => 'form-input text2', 'placeholder' => '入力してください']) }}
                    ...
                    <tr>
                        ...
                        <td>
                            {{ Form::text('tel', $request->tel ?? null, ['class' => 'form-input text2', 'placeholder' => '入力してください']) }}
                            <br class="spOnlyunder">
                                    ...
                                    <ul>
                                        <li>
                                            <div class="selectTime">
                                                {{ Form::radio('price_system', 2, !empty($request->price_system) ? ($request->price_system == 2 ? true : false) : false, ['class' => 'radio-input', 'id' => 'price_system_radio2']) }}
                                                {{ Form::label('price_system_radio2', 'する') }}
                                                {{ Form::radio('price_system', 1, !empty($request->price_system) ? ($request->price_system == 1 ? true : false) : true, ['class' => 'radio-input', 'id' => 'price_system_radio1']) }}
                                                {{ Form::label('price_system_radio1', 'しない') }}
                                            </div>
                                        </li>
                                        <li><a target="_blank" rel="noopener noreferrer" href="https://system.osaka-conference.com/characteristic/high-grade/"><i class="fas fa-question-circle form-icon"></i>音響ハイグレードとは？</a></li>
                                    </ul>
                    ...
                    <tr>
                        ...
                        <td class="">
                            <ul>
                                <li>
                                    <div class="selectTime">
                                        {{ Form::radio('board_flag', 1, !empty($request->board_flag) ? ($request->board_flag == 1 ? true : false) : false, ['class' => 'radio-input', 'id' => 'board_flag']) }}
                                        {{ Form::label('board_flag', 'あり') }}
                                        {{ Form::radio('board_flag', 0, !empty($request->board_flag) ? ($request->board_flag == 0 ? true : false) : true, ['class' => 'radio-input', 'id' => 'no_board_flag']) }}
                                ...
                                <li class="cell-margin board_info">
                                    ...
                                    <div class="m-b10">
                                        <p>主催者名</p>
                                        <div class="form-counter">
                                            {{ Form::text('event_owner', $request->event_owner ?? null, ['class' => 'form-input text2', 'placeholder' => '入力してください', 'id' => 'eventownerCount']) }}
                    ...
                    @if ($venue->eat_in_flag != 0)
                        <tr>
                            ...
                            <td>
                                {{ Form::radio('eat_in', 1, !empty($request->eat_in) ? ($request->eat_in == 1 ? true : false) : false, ['id' => 'eat_in', 'class' => 'radio-input']) }}
                                {{ Form::label('eat_in', 'あり') }}
                                (
                                {{ Form::radio('eat_in_prepare', 1, !empty($request->eat_in_prepare) ? ($request->eat_in_prepare == 1 ? true : false) : false, ['class' => !empty($request->eat_in) ? ($request->eat_in == 1 ? 'radio-input' : '') : '', 'id' => 'eat_in_prepare', !empty($request->eat_in) ? 'test' : 'disabled']) }}
                                {{ Form::label('eat_in_prepare', '手配済み', ['style' => 'margin-right: 20px;']) }}
                                /
                                {{ Form::radio('eat_in_prepare', 2, !empty($request->eat_in_prepare) ? ($request->eat_in_prepare == 2 ? true : false) : false, ['class' => !empty($request->eat_in) ? ($request->eat_in == 1 ? 'radio-input' : '') : '', 'id' => 'eat_in_consider', !empty($request->eat_in) ? 'test' : 'disabled']) }}
                                {{ Form::label('eat_in_consider', '検討中', ['style' => 'margin-right: 20px;']) }}
                                )
                                <br>
                                {{ Form::radio('eat_in', 0, !empty($request->eat_in) ? ($request->eat_in == 0 ? true : false) : true, ['id' => 'no_eat_in', 'class' => 'radio-input']) }}
                                    ...
                                    @foreach ($venue->getEquipments() as $e_key => $eqpt)
                                        <li class="form-cell2">
                                            <div class="text6 m-b20">
                                                ...
                                                <p>
                                                    {{ number_format($eqpt->price) }}円<span class="annotation">(税抜)</span>
                                                </p>
                                            </div>
                                            <p class="m-l20">
                                                {{ Form::number('equipment_breakdown' . $e_key, $request->{'equipment_breakdown' . $e_key} ?? null, ['class' => 'text4 mL0number_validation', 'autocomplete="off"']) }}個
                                            </p>
                                        </li>
                                    @endforeach
                                </ul>
