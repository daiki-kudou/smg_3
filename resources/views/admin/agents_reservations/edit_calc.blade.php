                            ...
                            <td>
                                <select class="form-control" name="agent_id" id="agent_select">
                                    ...
                                    @foreach ($agents as $agent)
                                        <option value="{{ $agent->id }}" @if ($agent->id == $data['agent_id']) selected @endif>{{ $agent->name }} |
                    ...
                    <div class="bill_total">
                        <table class="table">
                            ...
                            <tr>
                                <td>消費税：</td>
                                <td>
                                    {{ Form::text('master_tax', ReservationHelper::getTax($master_subtotal), [
                                        'class' => 'form-control
                                                    text-right',
                                        'readonly',
                                    ]) }}
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ Form::text('master_total', ReservationHelper::taxAndPrice($master_subtotal), [
                                        'class' => 'form-control
                                                    text-right',
                                        'readonly',
                                    ]) }}
                    ...
                    <div class="informations billdetails_content py-3">
                        <table class="table">
                            <tr>
                                ...
                                <td>支払期日
                                    {{ Form::text('payment_limit', date('Y-m-d', strtotime($payment_limit)), [
                                        'class' => 'form-control
                                                    datepicker',
                                    ]) }}
                                </td>
                            ...
                            <tr>
                                <td>
                                    請求書宛名
                                    {{ Form::text('bill_company', ReservationHelper::getAgentCompany($agents->find($data['agent_id'])->id), ['class' => 'form-control']) }}
                                </td>
                                <td>
                                    担当者
                                    {{ Form::text('bill_person', ReservationHelper::getAgentPerson($agents->find($data['agent_id'])->id), ['class' => 'form-control']) }}
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">請求書備考
                    ...
                    <div class="py-3 paids billdetails_content">
                        <table class="table" style="table-layout: fixed;">
                            <tr>
                                ...
                                <td>
                                    入金日
                                    {{ Form::text('pay_day', !empty($data['pay_day']) ? date('Y-m-d', strtotime($data['pay_day'])) : '', [
                                        'class' => 'form-control
                                                    datepicker',
                                    ]) }}
                                </td>
