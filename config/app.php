...
return [
  ...
  // 'url' => env('APP_URL', 'http://127.0.0.1:8000'),　これ変更した
  ...
  'admin_email' => ['maruoka@web-trickster.com', 'kudou@web-trickster.com'],
  ...
  'providers' => [
    ...
    Illuminate\Auth\Passwords\PasswordResetServiceProvider::class, //ここをコメントアウト　リセットパスワード用にオーバーライドするため
