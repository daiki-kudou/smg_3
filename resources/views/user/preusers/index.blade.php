          ...
          <div class="bgColorGray">
            <table>
              ...
              <tr>
                ...
                <td>
                  <input name="mail02" id="mail02" class="text1" type="email">
...
<input type="email" class="form-control" id="email" aria-describedby="emailHelp" placeholder="sample@sample.com"
  name="email">
<button type="submit" class="btn btn-primary">送信する</button>
