...
<body>
  ...
  本メールをもちまして<br />
  下記の通り、予約が完了しました。<br />
  ご確認の上、支払期日までに利用料金をお振込下さいますよう<br />
  よろしくお願いいたします。<br />
  <br />
  ▼マイページログイン<br />
  ...
  【予約キャンセル・変更について】<br />
  ────────────────<br />
  本メールをもって「予約完了」しております。<br />
  これより予約変更・キャンセルをされる場合は、<br />
  原則、キャンセル料金が発生致しますのでご了承下さい。<br />
  キャンセルポリシー<br />
  https://osaka-conference.com/cancelpolicy/<br />
  ────────────────<br />
  ▼マイページログイン<br />
  <a href="{{url('/user/login')}}">マイページ</a><br />
  貸し会議室の予約申込み、予約内容の確認、<br />
  会員情報変更などが可能です。<br />
  ────────────────<br />
  <br />
