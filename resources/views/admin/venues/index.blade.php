      ...
      <div class="col-12">
        <div class="d-flex col-12 flex-wrap">
          <dl class="form-group flex-fill">
            <dt>
              <label class="search_item_name" for="id">会場ID</label>
            </dt>
            <dd>
          ...
          <dl class="form-group flex-fill">
            <dt>
              <label class="search_item_name" for="alliance_flag">直営・提携</label>
            </dt>
            <dd>
          ...
          <dl class="form-group flex-fill">
            <dt>
              <label class="search_item_name" for="name_area">エリア別</label>
            </dt>
            <dd>
          ...
          <dl class="form-group flex-fill">
            <dt>
              <label class="search_item_name" for="name_bldg">ビル名</label>
            </dt>
            <dd>
          ...
          <dl class="form-group flex-fill">
            <dt>
              <label class="search_item_name" for="name_venue">会場名</label>
            </dt>
            <dd>
          ...
          <dl class="form-group flex-fill">
            <dt>
              <label class="search_item_name" for="name_bldg">収容人数（~名以上）</label>
            </dt>
            <dd>
          ...
          <dl class="form-group flex-fill">
            <dt>
              <label class="search_item_name" for="name_venue">収容人数（~名以下）</label>
            </dt>
            <dd>
