            ...
            <header>
                ...
                <div class="contents">
                    ...
                    <div class="headerInfo">
                        <p class="txt"><span
                                class="head_smgaccea">SMGアクセア貸し会議室</span><br>大阪市内主要駅(新大阪・梅田)から好アクセス・駅近。～100名の中小会場が格安で基本備品無料！
                        </p>
                ...
                <nav>
                    <ul class="mainNav">
                        <li><a href="https://osaka-conference.com/"><img
                                    src="https://osaka-conference.com/img/icon_home.png" alt="HOME" class="off"><img
                                    src="https://osaka-conference.com/img/icon_home_on.png" alt="HOME" class="on"></a></li>
                        ...
                        <li>
                            <ul class="sp formBtnBlock">
                                ...
                                <li><a href="https://osaka-conference.com/reservation/"><img
                                            src="https://osaka-conference.com/img/ico_form02@2x.png" alt="本申込み">本申込み</a>
                                </li>
                            </ul>
                            <div class="sp contactBlock">
                                ...
                                <div class="allbtn green"><a href="https://osaka-conference.com/contact/"><img
                                            src="https://osaka-conference.com/img/icon_mail.png"
                                            alt="問い合わせ"><span>問い合わせ</span></a></div>
                            </div>
                        </li>
                    </ul>
                </nav>
                    ...
                    <ol class="bread" itemscope itemtype="http://schema.org/BreadcrumbList">
                        <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                            <a itemscope itemtype="http://schema.org/Thing" itemprop="item"
                                href="https://osaka-conference.com/">
                                <span itemprop="name"><img src="https://osaka-conference.com/img/icon_bread.png"
                                        alt="HOME"></span></a>
            ...
            <div class="banner">
                <ul class="contents pc">
                    ...
                    <li><a href="https://osaka-conference.com/catering/"><img
                                src="https://osaka-conference.com/img/banner_catering02.jpg" alt="ケータリングサービスお弁当の手配"></a>
                    </li>
                </ul>
                <ul class="contents sp">
                    ...
                    <li><a href="https://osaka-conference.com/catering/"><img
                                src="https://osaka-conference.com/img/banner_catering02@2x.jpg" alt="ケータリングサービスお弁当の手配"></a>
                    </li>
                </ul>
            </div>
            <footer class="new">
                <nav class="contents">
                        ...
                        <ul class="pc">
                            ...
                            <li class="download">
                                ...
                                <p class="download_btn3 btnOrange"><a href="https://osaka-conference.com/reservation/"
                                        target="_blank"><img src="https://osaka-conference.com/img/ico_form.png"
                                            alt="本申込み">フォーム</a></p>
                                <p class="download_btn3 btnOrange"><a href="https://osaka-conference.com/downlord/form.pdf"
                                        target="_blank"><img src="https://osaka-conference.com/img/ico_pdf.png"
                                            alt="PDF">PDF</a></p>
                                <p class="download_btn3 btnOrange"><a href="https://osaka-conference.com/downlord/form.xlsx"
                                        target="_blank"><img src="https://osaka-conference.com/img/ico_excel.png"
                                            alt="EXCEL">EXCEL</a></p>
                            </li>
                        </ul>
                        <ul class="sp">
                            ...
                            <li class="foot-btnM"><a href="https://osaka-conference.com/reservation/"><img
                                        src="https://osaka-conference.com/img/ico_form02@2x.png" alt="本申込みフォーム">本申込み</a>
                            </li>
                            <li class="foot-btnS"><a href="https://osaka-conference.com/downlord/form.pdf"
                                    target="_blank"><img src="https://osaka-conference.com/img/ico_pdf01@2x.png"
                                        alt="PDF">PDF</a></li>
                            <li class="foot-btnS"><a href="https://osaka-conference.com/downlord/form.xlsx"
                                    target="_blank"><img src="https://osaka-conference.com/img/ico_excel01@2x.png"
                        ...
                        <div class="foot-tel-wrap sp">
                            <div class="tel">
                                ...
                                <p class="telNo"><em><a href="tel:0665566462"
                                            onclick="gtag('event','tel-tap',{'event_category':'click'});">06-6556-6462</a></em>
                                </p>
                    ...
                    <ul class="footerpagelist pc">
                        ...
                        <li><a href="https://osaka-conference.com/characteristic/">特徴</a></li>
                        <li><a href="https://osaka-conference.com/flow/">利用の流れ</a></li>
                        <li><a href="https://osaka-conference.com/rental/about/TermsOfService.pdf" target="_blank">利用規約</a>
                        </li>
                    ...
                    <ul class="footerpagelist pc">
                        ...
                        <li><em class="footerLink"><a href="https://osaka-conference.com/privacypolicy/">プライバシーポリシー</a></em>
                        </li>
                    </ul>
                    ...
                    <div class="sp">
                        ...
                        <ul class="footerpagelist">
                            ...
                            <li><a href="https://osaka-conference.com/characteristic/">特徴</a></li>
                            <li><a href="https://osaka-conference.com/flow/">利用の流れ</a></li>
                            <li><a href="https://osaka-conference.com/rental/about/TermsOfService.pdf"
                            ...
                            <li><a href="https://osaka-conference.com/seminar-manual/">セミナー主催者マニュアル</a></li>
                            <li><a href="https://osaka-conference.com/company/">会社概要</a></li>
                            <li><em class="footerLink"><a
                                        href="https://osaka-conference.com/privacypolicy/">プライバシーポリシー</a></em></li>
                        </ul>
            ...
            <div class="pc banner sticky">
                <div class="block contents">
                    <ul>
                        ...
                        <li><a href="https://osaka-conference.com/characteristic/free-equipment/"><img
                                    src="https://osaka-conference.com/img/banner_freegoods_mini.png" alt="無料備品が多数！"></a>
                        </li>
                        <li><a href="https://osaka-conference.com/characteristic/night-use/"><img
