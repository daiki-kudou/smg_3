            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  $PreReservation->luggage_return,['class'=>'form-control','id'=>'luggage_return','min'=>0] ) }}
            ...
            <table class="table table-borderless">
              ...
              <tbody class="venue_main">
                ...
                <tr>
                  ...
                  <td>
                    {{ Form::text('venue_breakdown_count'.$key, $v_break->unit_count,['class'=>'form-control col-xs-3',
                    'readonly'] ) }}
                  </td>
                  <td>
          ...
          <div class="equipment billdetails_content">
            <table class="table table-borderless">
              ...
              <tbody class="equipment_main">
                ...
                <tr>
                  <td>
                    {{ Form::text('equipment_breakdown_item'.$key, $e_break->unit_item,['class'=>'form-control
                    col-xs-3', 'readonly'] ) }}
                  </td>
                  <td>
                    {{ Form::text('equipment_breakdown_cost'.$key, $e_break->unit_cost,['class'=>'form-control
                    col-xs-3', 'readonly'] ) }}
                  </td>
                  <td>
                ...
                <tr>
                  ...
                  <td>
                    {{ Form::text('services_breakdown_count'.$key, $s_break->unit_count,['class'=>'form-control
                    col-xs-3', 'readonly'] ) }}
                  </td>
                  <td>
