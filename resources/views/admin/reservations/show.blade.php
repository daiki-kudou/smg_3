...
@section('content')
    ...
    <div>
        ...
        @if ($reservation->bills->sortBy('id')->first()->double_check_status <= 1 && (int) $reservation->bills->sortBy('id')->first()->reservation_status < 3)
        ...
        @endif
        @if ((int) $reservation->bills->sortBy('id')->first()->reservation_status < 3 && (int) $reservation->bills->sortBy('id')->first()->double_check_status === 2)
            <div class="alert-box d-flex align-items-center mb-0">
                <p class="w-100 text-center">
                    ダブルチェック完了。<br>
        ...
        @if ((int) $reservation->bills->sortBy('id')->first()->reservation_status === 3)
            @foreach ($reservation->bills->sortBy('id')->skip(1)->toArray() as $key => $item)
                ...
                @endif
                @if ((int) $item['double_check_status'] === 2 && (int) $item['reservation_status'] < 3)
                    <div class="alert-box d-flex align-items-center mb-0">
                        <p class="w-100 text-center">
                ...
                <div class="col">
                    <table class="table table-bordered">
                        <tr>
                            <td colspan="2">
                                <div class="d-flex align-items-center">
                                    ...
                                    <p class="ml-3">
                                        一括ID：
                                        {{ !empty($reservation->multiple_reserve_id) ? ReservationHelper::Fixid($reservation->multiple_reserve_id) : '' }}
                                    </p>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <p>
                                    {{ ReservationHelper::getVenue($reservation->venue_id) }}{{ $reservation->price_system == 1 ? '通常（枠貸）' : '(音響HG)' }}
                                </p>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <table class='table table-bordered' style="table-layout:fixed;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if (isset($reservation->luggage_count) && $reservation->luggage_flag == 1)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if (!empty($reservation->luggage_arrive) && $reservation->luggage_flag == 1)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if (isset($reservation->luggage_return) && $reservation->luggage_flag == 1)
                        ...
                        <tbody>
                            <tr>
                                ...
                                @elseif ($reservation->bills->sortBy('id')->first()->double_check_status == 1)
                                    <td>
                                        <div class="d-flex">
                                            <p class="bg-status p-2">一人目チェック</p>
                                            <p class="border p-2">
                                                {{ $reservation->bills->sortBy('id')->first()->double_check1_name }}
                                            </p>
                                        </div>
                                    </td>
                                    <td>
                                ...
                                @elseif ($reservation->bills->sortBy('id')->first()->double_check_status == 2)
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <p class="bg-status p-2">二人目チェック</p>
                                            <p class="border p-2">
                                                {{ $reservation->bills->sortBy('id')->first()->double_check2_name }}
                                            </p>
                                        </div>
                                    </td>
                                @endif
                                <td class="text-right">
                                    ...
                                    <div>
                                        <span>予約確定日：</span>{{ ReservationHelper::formatDate($reservation->bills->sortBy('id')->first()->cfm_at) }}
                                    </div>
                                </td>
                            </tr>
                        </tbody>
                ...
                <div class="paid_details">
                    <div class="head d-flex">
                        <div class="d-flex align-items-center justify-content-between w-100">
                            ...
                            @csrf
                            {{ Form::hidden('bill_id', $reservation->bills->sortBy('id')->first()->id) }}
                            @if ($reservation->bills->sortBy('id')->first()->paid == 1 || $reservation->bills->sortBy('id')->first()->paid == 5)
                    ...
                    <div class="main">
                        ...
                        <div class="text-right billdetails_content pb-0">
                            <input type="checkbox" class="paid_edit_m" id="{{ 'paid_edit_m' . $reservation->bills->sortBy('id')->first()->id }}">
                                    ...
                                    <tr>
                                        <td>振込名：
                                            {{ Form::text('pay_person', $reservation->bills->sortBy('id')->first()->pay_person, [
                                                ...
                                                'disabled',
                                                'data-error_placement=".pay_person"',
                                            ]) }}
                                            <p class="pay_person" style="color: red"></p>
                                        </td>
                                        <td>入金額：
                                            {{ Form::text('payment', $reservation->bills->sortBy('id')->first()->payment, [
                                                'class' => 'form-control paid_edit',
                                                'disabled',
                                                'data-error_placement=".payment"',
                                            ]) }}
                        ...
                        <table class="table">
                            <tbody>
                                <tr>
                                    ...
                                    <td class="text-right">
                                        <div>
                                            <span>申込日：</span>{{ ReservationHelper::formatDate($other_bill->created_at) }}
                                        </div>
                                        <div>
                    ...
                    <div class="paid_details">
                        <div class="head d-flex">
                            <div class="d-flex align-items-center justify-content-between w-100">
                                ...
                                {{ Form::hidden('reservation_id', $reservation->id) }}
                                {{ Form::hidden('bill_id', $other_bill->id) }}
                                @if ($other_bill->paid == 1 || $other_bill->paid == 5)
                                    <p class="mr-2">
                                        ...
                                        <tr>
                                            <td>振込名：
                                                {{ Form::text('pay_person', $other_bill->pay_person, [
                                                    'class' => 'form-control paid_edit',
                                                    'disabled',
                                                    'data-error_placement=".pay_person2"',
                                                ]) }}
                                                <p class="pay_person2" style="color: red"></p>
                                            </td>
                                            <td>入金額：
                                                {{ Form::text('payment', $other_bill->payment, [
                                                    'class' => 'form-control paid_edit',
                                                    'disabled',
                                                    'data-error_placement=".payment2"',
                                                ]) }}
                                ...
                                <table class="table table-borderless">
                                    ...
                                    <tbody class="venue_result">
                                        <tr>
                                            <td colspan="3"></td>
                                            <td colspan="1" class="">
                                                合計：{{ number_format($cxl->master_subtotal) }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                {{ Form::text('pay_day', !empty($cxl->pay_day) ? date('Y-m-d', strtotime($cxl->pay_day)) : '', [
                                                    'class' => 'form-control cxl_paid_edit datepicker_no_min_date',
                                                    'disabled',
                                                ]) }}
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>振込名：
                                                {{ Form::text('pay_person', $cxl->pay_person, [
                                                    'class' => 'form-control cxl_paid_edit',
                                                    'disabled',
                                                    'data-error_placement=".pay_person3"',
                                                ]) }}
                                                <p class="pay_person3" style="color: red"></p>
                                            </td>
                                            <td>
                                                入金額：
                                                {{ Form::text('payment', $cxl->payment, [
                                                    'class' => 'form-control cxl_paid_edit',
                                                    'disabled',
                                                    'data-error_placement=".payment3"',
                                                ]) }}
