...
$(function(){
  $(function(){
    ...
    $('.count_num1').html(len + "/32");
});

  $('#eventname1Count').on('keyup', function(){
...
$(function(){
  $(function(){
    ...
    $('.count_num2').html(len + "/32");
});

  $('#eventname2Count').on('keyup', function(){
    var len = textLength($(this).val());
...
$(function(){
  $(function(){
    ...
    $('.count_num3').html(len + "/60");
});

  $('#eventownerCount').on('keyup', function(){
    var len = textLength($(this).val());
