...
<script src="{{ asset('/js/agent_reserve_ajax.js') }}"></script>
    ...
    <div class="col">
      <div class="client_mater">　
        <table class="table table-bordered name-table">
          ...
          <tr>
            <td class="table-active"><label for="agent_id" class=" form_required">サービス名称</label></td>
            <td>
          ...
          <tr>
            ...
            <td>
              <p class="selected_person">
                {{ Form::text('selected_person', '',['class'=>'form-control selected_person', 'readonly'] ) }}
              </p>
            </td>
          </tr>
        </table>
      ...
      <table class="table table-bordered sale-table">
        <tr>
          <td colspan="2">
            <p class="title-icon" style="font-weight: bold;">
...
<section class="bill-wrap section-wrap">
  ...
  <div class="total_result">
    <table class="table table-bordered" style="table-layout:fixed;">
      <thead>
        <tr>
          <td colspan="3" style="background: #35A7A7; color:white; font-weight:bold;">
            合計請求額
          </td>
        </tr>
      </thead>
