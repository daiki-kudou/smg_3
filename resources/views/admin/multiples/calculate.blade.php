    ...
    <section class="border-wrap2 pb-5">
      ...
      <section class="m-5 border-inwrap">
                ...
                <div class="col">
                  ...
                  <table class="table table-bordered equipment-table">
                    <thead class="accordion-ttl">
                      <tr>
                        <th colspan="2">
                          <p class="title-icon active"><i class="fas fa-wrench icon-size fa-fw"></i>有料備品</p>
                        </th>
                      </tr>
                    </thead>
                  ...
                  <table class="table table-bordered service-table">
                    <thead class="accordion-ttl">
                      <tr>
                        <th colspan="2">
                          <p class="title-icon active"><i class="fas fa-hand-holding-heart icon-size fa-fw"></i>有料サービス<span class="open_toggle"></span></p>
                        </th>
                      </tr>
                    </thead>
                    <tbody class="accordion-wrap" style="display: none;">
                  ...
                  <table class="table table-bordered layout-table">
                    <thead class="accordion-ttl">
                      <tr>
                        <th colspan="2">
                          <p class="title-icon active"><i class="fas fa-th icon-size fa-fw"></i>レイアウト<span class="open_toggle"></span></p>
                        </th>
                      </tr>
                    </thead>
                    <tbody class="accordion-wrap" style="display: none;">
                  ...
                  <table class="table table-bordered luggage-table" style="table-layout: fixed;">
                    <thead class="accordion-ttl">
                      <tr>
                        <th colspan="2">
                          <p class="title-icon active"><i class="fas fa-suitcase-rolling icon-size fa-fw"></i>荷物預かり<span class="open_toggle"></span></p>
                        </th>
                      </tr>
                    </thead>
                    <tbody class="accordion-wrap" style="display: none;">
          ...
          <div class="btn_wrapper">
            <p class="text-center">
              {{ Form::submit('計算する', ['class' => 'mt-3 btn more_btn_lg mx-auto d-block my-5'])}}
              {{ Form::close() }}
            </p>
          </div>
      </section>
        ...
        <div class="register-list-item">
          ...
          <dl class="card">
            ...
            <dt class="accordion-wrap" style="display: none;">
              ...
              <div class="btn_wrapper">
                <p class="text-center">
                  {{ Form::submit('請求に反映する', ['class' => 'btn btn-primary'])}}
                </p>
                {{ Form::close() }}
              </div>
              <!-- 請求セクション------------------------------------------------------------------- -->
