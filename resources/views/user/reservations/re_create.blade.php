                                ...
                                <ul>
                                    <li>
                                        <div class="selectTime">
                                            {{ Form::radio('price_system', 2, (int) $fix->price_system === 2 ? true : false, ['class' => 'radio-input', 'id' => 'price_system_radio2']) }}
                                            {{ Form::label('price_system_radio2', 'する') }}
                                            {{ Form::radio('price_system', 1, (int) $fix->price_system === 1 ? true : false, ['class' => 'radio-input', 'id' => 'price_system_radio1']) }}
                                            {{ Form::label('price_system_radio1', 'しない') }}
                                        </div>
                                    </li>
                                    <li>
                                        <a target="_blank" rel="noopener noreferrer" href="https://system.osaka-conference.com/characteristic/high-grade/">
            ...
            <tr>
                ...
                <td class="spec-space">
                    <div class="selectTime m-b10">
                        {{ Form::radio('luggage_flag', 1, (int) $fix->luggage_flag === 1 ? true : false, ['id' => 'luggage_flag', 'class' => 'radio-input']) }}
                        {{ Form::label('luggage_flag', 'あり') }}
                        {{ Form::radio('luggage_flag', 0, (int) $fix->luggage_flag === 0 ? true : false, ['id' => 'no_luggage_flag', 'class' => 'radio-input']) }}
                    ...
                    <ul class="luggage_info">
                        <li class="m-b10">
                            <div class="luggage-cell">
                                <p>事前に預かる荷物(目安)</p>
                                {{ Form::number('luggage_count', $fix->luggage_count ?? null, ['class' => 'text6 ', 'style' => 'width:20%;', 'autocomplete="off"', 'min' => 0]) }}
                                <p class="">個</p>
                            </div>
                        ...
                        <li class="m-b10">
                            <div class="luggage-cell">
                                <p>事後返送する荷物</p>
                                {{ Form::number('luggage_return', $fix->luggage_return ?? null, ['class' => 'text6 ', 'style' => 'width:20%;', 'autocomplete="off"', 'min' => 0]) }}
                                <p class="">個</p>
                            </div>
...
<section class="contents">
  ...
  {{ Form::open(['url' => '/user/reservations/check', 'method'=>'POST', 'id'=>'user_reservation_re_calculate','autocomplete'=>'off',]) }}
  <div class="bgColorGray first">
    <table>
      <tr>
        <th>利用日</th>
